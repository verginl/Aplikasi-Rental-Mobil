...
<br>
       ...
       <tr>
        ...
        <tr>
            ...
            <td align="center">:</td>
            <td width="250"> <?php echo $edit['tgl_selesai'] ?></td>       
        </tr>

        <tr>
            <td width="30">&nbsp;&nbsp;Telat Dikembalikan Selama</td>
            <td align="center">:</td>
            <td width="250"> <?php echo $edit['jml_hari_telat'] ?> Hari</td>       
        </tr>

        <tr>
            <td width="30">&nbsp;&nbsp;Biaya Cuci</td>
            <td align="center">:</td>
            <td width="250">Rp. <?php echo $edit['biaya_cuci'] ?></td>       
        </tr>
        <tr>
            <td width="30">&nbsp;&nbsp;Denda / Biaya Lainnya</td>
            <td align="center">:</td>
            <td width="250">Rp. <?php echo $edit['denda'] ?></td>       
        </tr>
        <tr>
            <td width="30"><b>Status Transaksi</b></td>
            <td align="center"><b>:</b></td>
            <td width="250"><b><?php echo $edit['status_transaksi'] ?></b></td>       
        </tr>
