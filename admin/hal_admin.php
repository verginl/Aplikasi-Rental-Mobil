      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="?menu=input_customer">Input Customer</a>
            <a class="collapse-item" href="?menu=input_mobil">Input Mobil</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="collapseData" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="?menu=data_customer">Data Customer</a>
            <a class="collapse-item" href="?menu=data_mobil">Data Mobil</a>
...
<li class="nav-item">
        ...
        <div id="collapseTransaksi" class="collapse" aria-labelledby="headingTransaksi" data-parent="#accordionSidebar">
          ...
          <h6 class="collapse-header"> Transaksi :</h6>
            <a class="collapse-item" href="?menu=pilih_mobil">Booking</a>
            <a class="collapse-item" href="?menu=pengembalian">Pengembalian</a>
          <div class="collapse-divider"></div>
            <h6 class="collapse-header"> Pembayaran :</h6>
            <a class="collapse-item" href="?menu=pembayaran">Pembayaran</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseDataTransaksi" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="?menu=data_booking">Data Booking</a>
            <a class="collapse-item" href="?menu=data_transaksi">Data Transaksi</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="?menu=laporan">Laporan Transaksi</a>
                     </div>
        </div>
      <hr class="sidebar-divider">
