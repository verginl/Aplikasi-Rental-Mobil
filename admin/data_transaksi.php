...
<h1 class="h3 mb-2 text-gray-800">Data Transaksi Penyewaan</h1>
...
<!-- DataTales Example -->
          <div class="card border-left-danger shadow h-100 my-0 shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-danger">Data Transaksi Penyewaan Mobil</h6>
            </div>
            <div class="card-body">
...
<td><?php echo $row['nama_mobil'].', '.$row['warna_mobil'] .', '.$row['plat_nomor']?></td>
<td><?php echo $row['tgl_sewa']?> </td>
<td><?php echo $row['tgl_kembali']?> </td>
<td><?php echo $row['status_transaksi']?> </td>
  <td width="100" align="center"> <a href="?menu=pengembalian&edit&id=<?php echo $row['id_transaksi'] ?>"><input  type="submit" name="edit" value="Selesai" class="btn btn-danger"></a></td>
