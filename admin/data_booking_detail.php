...
<h1 class="h3 mb-2 text-gray-800">Detail Booking Sewa Mobil a/n <?php echo $edit['nama_customer']?></h1>
...
<!-- DataTales Example -->
          <div class="card border-left-danger shadow h-100 my-0 shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-danger">Data Detail Booking</h6>
            </div>
            <div class="card-body">
  ...
  <img  class="rounded mx-auto d-block" height="200" width="200" src="../img/admin2-01.png" alt="Foto Tidak Tersedia">
    ...
    <td>Tanggal Booking</td>
      <td>:</td>
      <td><?php echo $edit['tgl_booking'] ?></td>
    </tr>
    <tr>
    <td>Mobil</td>
      <td>:</td>
   ...
   <a href="struk_customer.php?menu=struk_customer&edit&id=<?php echo$edit['id_booking'] ?>"><input  type="submit" name="edit" value="Cetak Struk" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm "></a>


  <?php if (@$edit['status_pembayaran']=== "Belum Lunas"){ ?>
    <a href="?menu=pembayaran&edit&id=<?php echo $edit['id_booking'] ?>"><input  type="submit" name="edit" value="Pembayaran" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm "></a>
<?php
  }else{ ?>

    <a href="?menu=data_booking&hapus&id=<?php echo $row['id_booking'] ?>"><input  type="submit" name="edit" value="Berangkat Sewa" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
    <?php }?>
    </div>
  </div>
              </div>
