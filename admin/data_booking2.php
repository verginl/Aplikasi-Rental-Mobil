...
<div class="form-group row">
      <label for="example-search-input" class="col-3 col-form-label">Jam Sewa</label>
      <div class="col-3">
    <input class="form-control"  name="jam_sewa" type="time" value="<?php echo @$edit['jam_sewa']  ?>" required readonly  id="example-time-input">
...
nominal_pelunasan = parseInt($('#nominal_pelunasan').val());
var sisa_bayar_akhir = nominal_pelunasan + sisa_bayar;
